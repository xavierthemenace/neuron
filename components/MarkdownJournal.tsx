  ...
  return (
    <div className="space-y-2 text-[13px] leading-relaxed text-neutral-300">
      {blocks.map((block, index) => {
        ...
        if (block.kind === "code") {
          return <pre key={key} className="overflow-x-auto rounded-lg border border-white/8 bg-[rgb(25_22_20_/_0.05)] p-3 font-mono text-[11px] text-neutral-300">{block.text}</pre>;
        }
...
export function MarkdownJournal({
  ...
  return (
    <section className="rounded-xl border border-white/10 bg-[rgb(25_22_20_/_0.035)] p-3">
      <div className="flex items-center gap-2">
        ...
        <div className="ml-auto flex rounded-lg border border-white/8 bg-[rgb(25_22_20_/_0.035)] p-0.5">
      ...
      <div className="mt-3 min-h-36">
        {mode === "edit" && (
          <textarea
            ...
            className="min-h-40 w-full resize-y rounded-lg border border-white/10 bg-[rgb(25_22_20_/_0.035)] p-3 font-mono text-xs leading-relaxed text-neutral-200 outline-none placeholder:text-neutral-600 focus:border-white/25"
          />
        )}
        {mode === "preview" && (
          <div className="min-h-40 rounded-lg border border-white/8 bg-[rgb(25_22_20_/_0.035)] p-3">
