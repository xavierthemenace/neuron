...
export function SessionLauncher({
  ...
  return (
    <button
      ...
      onClick={onOpen}
      className={[
        "pointer-events-auto absolute bottom-4 left-16 z-30 flex min-h-[44px] items-center gap-2 rounded-full border border-cyan-200/15 bg-[rgb(255_255_255_/_0.93)] px-3.5 py-2 text-[11px] font-medium text-cyan-50/85 shadow-xl backdrop-blur-xl transition-colors hover:border-cyan-200/35 hover:text-white",
