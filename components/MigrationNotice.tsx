...
export function MigrationNotice() {
  ...
  return (
    ...
    <div className="pointer-events-auto fixed left-1/2 top-20 z-50 w-[min(30rem,calc(100vw-2rem))] -translate-x-1/2 rounded-xl border border-violet-300/20 bg-[var(--panel)] p-4 shadow-2xl backdrop-blur-xl md:bottom-4 md:top-auto">
