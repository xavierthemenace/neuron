...
export function PwaStatus() {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed bottom-3 left-1/2 z-[90] -translate-x-1/2 rounded-full border border-white/12 bg-[var(--toast)] px-3 py-1.5 text-[10px] text-neutral-300 shadow-xl backdrop-blur-xl"
    >
      {online ? (
        <button
          type="button"
